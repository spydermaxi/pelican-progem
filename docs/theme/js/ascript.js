...
function(e) {
    ...
    function() {
      ...
      if ("undefined" != typeof gh_search_key && "" != gh_search_key && "undefined" != typeof gh_search_migration) {
        ...
        var r, e = c(".search-field"),
          ...
          o = c(".search-result"),
          a = c(".popular-wrapper"),
          t = ("undefined" == typeof gh_search_content || gh_search_content, siteUrl + "/ghost/api/v3/content/posts/?key=" + gh_search_key + "&limit=all&fields=id,title,excerpt,url,updated_at,visibility&order=updated_at%20desc&formats=plaintext"),
          n = JSON.parse(localStorage.getItem("ease_search_index"));
        elasticlunr.clearStopWords(), localStorage.removeItem("ease_index"), localStorage.removeItem("ease_last"), n && gh_search_migration == localStorage.getItem("ease_search_migration") ? (r = elasticlunr.Index.load(n), c.get(t + "&filter=updated_at:>'" + localStorage.getItem("ease_search_last").replace(/\..*/, "").replace(/T/, " ") + "'", function(e) {
          ...
          var t = r.search(e.target.value, {
              expand: !0
            }),
            n = "";
          t.forEach(function(e) {
            n += '<div class="search-result-row"><a class="search-result-row-link" href="' + e.doc.url + '"><div class="search-result-row-title">' + e.doc.title + '</div><div class="search-result-row-excerpt">' + e.doc.excerpt + "</div></a></div>"
          }), o.html(n), 0 < e.target.value.length ? i.addClass("search-button-clear") : i.removeClass("search-button-clear"), 0 < t.length ? a.hide() : a.show()
        }), c(".search-form").on("submit", function(e) {
          e.preventDefault()
        }), i.on("click", function() {
  ...
  i(), t.on({
    ...
    function() {
      ...
      function n() {
        l.removeClass(["theme-dark", "theme-light"]), localStorage.removeItem("attila_theme"), t.text(e.attr("data-system"))
      }

      function r() {
        l.removeClass("theme-light").addClass("theme-dark"), localStorage.setItem("attila_theme", "dark"), t.text(e.attr("data-dark"))
      }

      function i() {
        l.removeClass("theme-dark").addClass("theme-light"), localStorage.setItem("attila_theme", "light"), t.text(e.attr("data-light"))
      }
